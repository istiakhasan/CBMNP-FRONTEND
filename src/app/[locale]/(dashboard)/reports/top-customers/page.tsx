...
import { useLazyTopCustomersReportsQuery, useTopCustomersReportsQuery } from "@/redux/api/customerApi";
import TopCustomers from "./_component/TopCustomers";
...
const Page = () => {
  ...
  const { data: smData, isLoading: summaryLoading } =
    useTopCustomersReportsQuery(undefined);
