...
import { useLazyDeliveryPartnerReportQuery, useLazyGetOrdersReportsQuery } from "@/redux/api/orderApi";
...
import ShipmentReportTable from "./_component/ShipmentReportTable";
...
const Page = () => {
  ...
  const [loadProcurement] = useLazyDeliveryPartnerReportQuery();
  ...
  return (
    <div>
      <GbHeader title="Shipment Reports" />
